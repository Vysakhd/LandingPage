...
function Header() {
  return (
    <div className="flex"> 
      ...
      <p className="text-blue-500 font-roboto text-lg font-medium mt-[35px]">Services</p>
      ...
      <button className=" text-white text-center font-roboto text-base font-extra small bold uppercase w-[90px] h-[30px] flex-shrink-0 rounded-lg bg-blue-500 ml-[32px] mt-[32px]">Register</button>
